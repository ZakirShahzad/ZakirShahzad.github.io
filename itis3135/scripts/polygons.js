...
var numSize = parseFloat(prompt("Hello There!, Shahzadenterprises welcomes! To Start, Please input the number of sides from 0-10 to find out the name polygon"));

//Checker
var i = 0;
while (i == 0) {
    if (validateEntry(numSize)) 
    {
        var shape = getShape(numSize);
        alert(shape);
        i = 1;
    }
    else 
    {
        numSize = parseFloat(prompt("It looks like you typed in an invalid entry. Please type in a number 0 through 10."));
    }
}


// Thia is to display to AWNSER
...
//Checking the validateity if Number of Side is Valid
